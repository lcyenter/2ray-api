...
config_docker(){
    ...
    curl -L https://raw.githubusercontent.com/lcyenter/2ray-api/master/Docker/V2ray/docker-compose.yml > docker-compose.yml
...
config_caddy_docker(){
    ...
    echo "install curl"
    install_dependencies
    curl -L https://raw.githubusercontent.com/lcyenter/2ray-api/master/Docker/Caddy_V2ray/Caddyfile >  Caddyfile
    echo "Writing docker-compose.yml"
    curl -L https://raw.githubusercontent.com/lcyenter/2ray-api/master/Docker/Caddy_V2ray/docker-compose.yml > docker-compose.yml
    sed -i "s|node_id:.*|node_id: ${ssrpanel_node_id}|"  ./docker-compose.yml
    sed -i "s|sspanel_url:.*|sspanel_url: '${ssrpanel_url}'|"  ./docker-compose.yml
    sed -i "s|key:.*|key: '${ssrpanel_key}'|"  ./docker-compose.yml
    sed -i "s|speedtest:.*|speedtest: ${ssrpanel_speedtest}|"  ./docker-compose.yml
